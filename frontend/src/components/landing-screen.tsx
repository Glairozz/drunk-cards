  ...
  return (
    ...
    >
      ...
      <h1 className="flex flex-col gap-0.5 mb-3">
        <span className="font-heading text-4xl sm:text-[2.8rem] font-extrabold leading-tight -tracking-wide text-white">
          Drunk
        </span>
        <span className="font-heading text-4xl sm:text-[2.8rem] font-extrabold leading-tight -tracking-wide bg-gradient-to-r from-[#ff6b35] via-[#ff8c5a] to-[#a855f7] bg-clip-text text-transparent animate-title-shimmer bg-[length:200%_100%]">
          Cards
        </span>
      </h1>

      <div className="flex items-center gap-2 sm:gap-3 text-[0.65rem] sm:text-xs text-white/50 tracking-widest uppercase mb-8 sm:mb-10">
        <span className="w-1 h-1 rounded-full bg-[#ff6b35] animate-pulse shrink-0" />
        <span>Party Game Edition</span>
        <span className="w-1 h-1 rounded-full bg-[#ff6b35] animate-pulse shrink-0" />
      </div>
      ...
      <span className="absolute bottom-4 sm:bottom-5 text-[0.65rem] sm:text-[0.7rem] tracking-widest text-white/30">v2.0</span>
    </motion.div>
  )
}
